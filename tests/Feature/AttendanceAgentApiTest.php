...
class AttendanceAgentApiTest extends TestCase {
 ...
 public function test_successful_batch_is_idempotent_on_replay():void{
  ...
  if(!$employee){$this->markTestSkipped('Employee fixture required to exercise AttendanceImporter.');}
  $payload=['batch_id'=>'stable-batch-1','device_identifier'=>'zk-office-1','logs'=>[['id'=>(int)$employee->id,'timestamp'=>'2026-09-10 09:00:00','type'=>0],['id'=>(int)$employee->id,'timestamp'=>'2026-09-10 17:00:00','type'=>1]]];
