...
@section('content')
<div class="widget-box"><div class="widget-header"><h4 class="widget-title"><i class="fa fa-user"></i> {{ $employee->exists ? 'Edit Employee' : 'Employee Details' }}</h4></div><div class="widget-body"><div class="widget-main">
...
</div><div class="form-actions"><button class="btn btn-info"><i class="fa fa-check"></i> Save Employee</button> <a href="{{ $employee->exists ? route('employees.index',['employee'=>$employee->id]) : route('employees.index') }}" class="btn btn-default" data-ajax-link>Cancel</a></div></form>
