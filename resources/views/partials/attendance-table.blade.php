<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover">
        <thead><tr>
            <th>Date</th>@if($showBranch ?? true)<th>Branch</th>@endif @if($showEmployee ?? true)<th>Employee</th><th>Machine Code</th>@endif
            <th>Time In</th><th>Time Out</th><th>Status</th><th>Working Hours</th><th>Early Min</th><th>Late Min</th><th style="width:70px">Edit</th>
        </tr></thead>
        ...
        <tr id="edit-attendance-{{ $attendance->id }}" style="display:none"><td colspan="{{ 8 + (($showEmployee ?? true) ? 2 : 0) + (($showBranch ?? true) ? 1 : 0) }}">
