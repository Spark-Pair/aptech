...
- Server batch IDs protect transport retries. Physical device log identity/checkpoint behavior is a separate concern and must pass physical tests before cutover.
